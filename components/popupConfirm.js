...
export class PopupConfirm {
    ...
    constructor() {
        ...
        this._text = '';
        this.messageText = null; // Store reference to the text element
    ...
    async show(message = 'Are you sure?', cancelText = 'Cancel', confirmText = 'Confirm', id = null, dontRemindText = null, alwaysConfirmText = null) {
        ...
        this.messageText.textContent = this._text; // Use the stored text value
        ...
        if (dontRemindText && this.id) {
            ...
            dontRemindBtn.textContent = dontRemindText; // e.g., "Don't show again"
        ...
        // Insert to the top of the container instead of the bottom
    ...
    frameUpdate(callback) {
        ...
        // Start animation loop only when the menu is visible
...
// Get the computed color value and ensure it is fully opaque
...
//
//     // Ensure the returned value is in rgb() format (without alpha)
